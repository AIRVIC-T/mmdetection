_base_ = [
    '../../MAR20/configs/mar20_scp_lsj.py', 'mmdet::_base_/schedules/schedule_3x.py',
...
train_dataloader = dict(dataset=dict(
    dataset=dict(dataset=dict(pipeline=load_pipeline), pipeline=train_pipeline)))
